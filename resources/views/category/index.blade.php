                ...
                <table class="table ">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td> #5469 </td>
                            <td>  <span class="name">Deportivas</span> </td>
                            <td>
            ...
            <div class="modal-content animated fadeIn">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label class=" form-control-label">Categoria input</label>
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-magic"></i></div>
                            <input class="form-control">
                        </div>
                        <small class="form-text text-muted">ex. Formal</small>
        ...
        <div class="modal-content animated fadeIn">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <small class="form-text text-muted">ex. Gala</small>
