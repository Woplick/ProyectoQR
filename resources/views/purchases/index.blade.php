                    ...
                    <table class="table ">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-edit"><i class="fa fa-pencil-square-o"></i>&nbsp; Añadir</button>
                                </td>
                            </tr>
...
<div class="row">
    <div class="col-12">
            <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Crear Compra</strong>
                    </div>
                    <div class="card-body">
                        <!-- Credit Card -->
                        <div id="pay-invoice">
