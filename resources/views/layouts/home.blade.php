        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="{{route('Color.index')}}"> <i class="menu-icon ti-email"></i>Colores </a>
                    </li>
                    <li>
                        <a href="{{route('Brand.index')}}"> <i class="menu-icon ti-email"></i>Marcas </a>
                    </li>
                    <li>
                        <a href="{{route('Category.index')}}"> <i class="menu-icon ti-email"></i>Categorias </a>
                    </li>
                    <li>
                        <a href="{{route('Size.index')}}"> <i class="menu-icon ti-email"></i>Tamños </a>
                    </li>
                    <li>
